...
The command will attempt to generate a `Dockerfile` for your PHAR. Once the file generated, you have free hands on it:
you can either use it right away (you just need to run `$ docker build .` to create the docker image) or you can tweak
it however you want.
...
« [PHAR code isolation](code-isolation.md) • [Table of Contents](../README.md#table-of-contents) »
