...
use HumbugBox463\Composer\Semver\Constraint\MatchAllConstraint;
use HumbugBox463\Composer\Semver\Constraint\MatchNoneConstraint;
use HumbugBox463\Composer\Semver\Constraint\MultiConstraint;
class Intervals
{
    /**
    @phpstan-var
