...
namespace HumbugBox435\Composer\Semver;

use HumbugBox435\Composer\Semver\Constraint\Constraint;
use HumbugBox435\Composer\Semver\Constraint\ConstraintInterface;
use HumbugBox435\Composer\Semver\Constraint\MatchAllConstraint;
use HumbugBox435\Composer\Semver\Constraint\MatchNoneConstraint;
use HumbugBox435\Composer\Semver\Constraint\MultiConstraint;
class Intervals
{
    /**
    @phpstan-var
