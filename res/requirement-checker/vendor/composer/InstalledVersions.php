...
namespace HumbugBox435\Composer;

use HumbugBox435\Composer\Autoload\ClassLoader;
use HumbugBox435\Composer\Semver\VersionParser;
    ...
    */
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('HumbugBox435\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
