...
namespace HumbugBox434\Composer;

use HumbugBox434\Composer\Autoload\ClassLoader;
use HumbugBox434\Composer\Semver\VersionParser;
    ...
    */
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('HumbugBox434\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
