...
namespace HumbugBox437\Composer;

use HumbugBox437\Composer\Autoload\ClassLoader;
use HumbugBox437\Composer\Semver\VersionParser;
    ...
    */
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('HumbugBox437\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
