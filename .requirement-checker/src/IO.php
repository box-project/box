    ...
    */
    private function checkColorSupport()
    {
        ...
        if (\DIRECTORY_SEPARATOR === '\\') {
            return \function_exists('_HumbugBoxc5a6d13bc633\\sapi_windows_vt100_support') && sapi_windows_vt100_support(\STDOUT) || \false !== \getenv('ANSICON') || 'ON' === \getenv('ConEmuANSI') || 'xterm' === \getenv('TERM');
        }
