    ...
    */
    private function checkColorSupport()
    {
        ...
        if (\DIRECTORY_SEPARATOR === '\\') {
            return \function_exists('_HumbugBoxf93f74f93d56\\sapi_windows_vt100_support') && sapi_windows_vt100_support(\STDOUT) || \false !== \getenv('ANSICON') || 'ON' === \getenv('ConEmuANSI') || 'xterm' === \getenv('TERM');
        }
