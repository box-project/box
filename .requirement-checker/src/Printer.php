...
final class Printer
{
    ...
    {
        if (null === $width) {
            $terminal = new \_HumbugBox90eb36759167\KevinGH\RequirementChecker\Terminal();
    ...
    public function getRequirementErrorMessage(\_HumbugBox90eb36759167\KevinGH\RequirementChecker\Requirement $requirement)
    {
