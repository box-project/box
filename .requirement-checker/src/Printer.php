...
final class Printer
{
    ...
    {
        if (null === $width) {
            $terminal = new \_HumbugBox87c495005ea2\KevinGH\RequirementChecker\Terminal();
    ...
    public function getRequirementErrorMessage(\_HumbugBox87c495005ea2\KevinGH\RequirementChecker\Requirement $requirement)
    {
