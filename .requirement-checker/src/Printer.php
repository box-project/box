...
final class Printer
{
    ...
    {
        if (null === $width) {
            $terminal = new \_HumbugBoxaa731ba336da\KevinGH\RequirementChecker\Terminal();
    ...
    public function getRequirementErrorMessage(\_HumbugBoxaa731ba336da\KevinGH\RequirementChecker\Requirement $requirement)
    {
