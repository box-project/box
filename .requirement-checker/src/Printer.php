...
final class Printer
{
    ...
    {
        if (null === $width) {
            $terminal = new \HumbugBox370\KevinGH\RequirementChecker\Terminal();
    ...
    public function getRequirementErrorMessage(\HumbugBox370\KevinGH\RequirementChecker\Requirement $requirement)
    {
