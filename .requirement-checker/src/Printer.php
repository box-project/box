...
final class Printer
{
    ...
    */
    ...
    {
        if (null === $width) {
            $terminal = new \_HumbugBox5af55af77d4cf\KevinGH\RequirementChecker\Terminal();
    ...
    */
    ...
    @return
    */
    public function getRequirementErrorMessage(\_HumbugBox5af55af77d4cf\KevinGH\RequirementChecker\Requirement $requirement)
    {
