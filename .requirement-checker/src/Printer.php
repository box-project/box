...
final class Printer
{
    ...
    */
    ...
    {
        if (null === $width) {
            $terminal = new \_HumbugBoxd1e70270db87\KevinGH\RequirementChecker\Terminal();
    ...
    */
    ...
    @return
    */
    public function getRequirementErrorMessage(\_HumbugBoxd1e70270db87\KevinGH\RequirementChecker\Requirement $requirement)
    {
