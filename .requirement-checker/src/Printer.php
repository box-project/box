...
final class Printer
{
    ...
    {
        if (null === $width) {
            $terminal = new \_HumbugBoxbb220723f65b\KevinGH\RequirementChecker\Terminal();
    ...
    public function getRequirementErrorMessage(\_HumbugBoxbb220723f65b\KevinGH\RequirementChecker\Requirement $requirement)
    {
