...
final class Printer
{
    ...
    */
    ...
    {
        if (null === $width) {
            $terminal = new \_HumbugBox5af562ac6f36a\KevinGH\RequirementChecker\Terminal();
    ...
    */
    ...
    @return
    */
    public function getRequirementErrorMessage(\_HumbugBox5af562ac6f36a\KevinGH\RequirementChecker\Requirement $requirement)
    {
