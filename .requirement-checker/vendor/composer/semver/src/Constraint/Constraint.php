...
class Constraint implements \HumbugBox373\Composer\Semver\Constraint\ConstraintInterface
{
    const OP_EQ = 0;
    const OP_LT = 1;
    const OP_LE = 2;
    ...
    public function matchSpecific(\HumbugBox373\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
