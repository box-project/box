...
class Constraint implements \_HumbugBoxbb220723f65b\Composer\Semver\Constraint\ConstraintInterface
{
    const OP_EQ = 0;
    const OP_LT = 1;
    const OP_LE = 2;
    ...
    public function matchSpecific(\_HumbugBoxbb220723f65b\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
