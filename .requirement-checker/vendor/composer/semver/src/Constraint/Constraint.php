...
class Constraint implements \_HumbugBox90eb36759167\Composer\Semver\Constraint\ConstraintInterface
{
    const OP_EQ = 0;
    const OP_LT = 1;
    const OP_LE = 2;
    ...
    public function matchSpecific(\_HumbugBox90eb36759167\Composer\Semver\Constraint\Constraint $provider, $compareBranches = \false)
    {
