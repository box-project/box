...
final class StubGenerator
{
    ...
    /**
     * @var string|null The top header comment banner text
     */
...
BANNER;
    ...
    /**
     * @var string|null The location within the PHAR of index script
     */
    private $index;
    ...
    /**
     * @var string|null The location of the script to run when a file is not found
     */
    private $notFound;

    /**
     * @var string|null The rewrite function name
     */
    private $rewrite;
