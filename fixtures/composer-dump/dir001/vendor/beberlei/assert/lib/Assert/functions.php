 ...
 */
function that($value, $defaultMessage = null, $defaultPropertyPath = null): AssertionChain
{
 ...
 * @param string $defaultPropertyPath
 */
function thatAll($values, $defaultMessage = null, $defaultPropertyPath = null): AssertionChain
{
 ...
 */
function thatNullOr($value, $defaultMessage = null, $defaultPropertyPath = null): AssertionChain
{
